...
import com.ferodev.drawroutes2.databinding.ActivityMain6Binding
...
class MainActivity6 : AppCompatActivity(), OnMapReadyCallback, LocationListener, GoogleMap.OnCameraMoveListener, GoogleMap.OnCameraMoveStartedListener, GoogleMap.OnCameraIdleListener  {
            ...
            location.addOnCompleteListener(object : OnCompleteListener<Location>{
                override fun onComplete(p0: Task<Location>) {
                    if (p0.isSuccessful){
                        ...
                        Toast.makeText(this@MainActivity6, "Current Location not Found.", Toast.LENGTH_SHORT).show()
                    }
                }
